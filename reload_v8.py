...
if arcpy.Exists(r"{}\brg_mpzp.gdb\OPISY".format(sciezka)):
    ...
    if "Class 1" in [layer.name for layer in mpzpMap.listLayers()]:
        cl = mpzpMap.listLayers("Class 1")[0]
        cl.name = "opisy_przeznaczenia"
    elif "Class 1_2" in [layer.name for layer in mpzpMap.listLayers()]:
        cl = mpzpMap.listLayers("Class 1_2")[0]
        cl.name = "opisy_przeznaczenia"
    elif "Class 1_3" in [layer.name for layer in mpzpMap.listLayers()]:

...
if arcpy.Exists(r"{}\brg_mpzp.gdb\OPISY".format(sciezka)):
    ...
    if arcpy.Exists("Class 1"):
        cl = mpzpMap.listLayers("Class 1")[0]
        cl.name = "opisy_przeznaczenia"
    elif arcpy.Exists("Class 1_2"):
        cl = mpzpMap.listLayers("Class 1_2")[0]
        cl.name = "opisy_przeznaczenia"
    elif arcpy.Exists("Class 1_3"):
        cl = mpzpMap.listLayers("Class 1_3")[0]
        cl.name = "opisy_przeznaczenia"
    else:
        pass
...
try:
    ...
    if "ERROR 000466" in e.args[0]:
        arcpy.management.Append(r"{}\brg_mpzp.gdb\BRG_MPZP\INNE_GRANICE_INFO".format(sciezka), r"{}\BRG_MPZP\INNE_GRANICE_INFO".format(workspace), "NO_TEST", r'nr_mpzp "nr_mpzp" true true false 10 Text 0 0,First,#,{}\brg_mpzp.gdb\BRG_MPZP\INNE_GRANICE_INFO,nr_mpzp,0,10;byt "rodzaj_bytu" true true false 255 Text 0 0,First,#,{}\brg_mpzp.gdb\BRG_MPZP\INNE_GRANICE_INFO,byt,0,255;numer "numer" true true false 10 Text 0 0,First,#,{}\brg_mpzp.gdb\BRG_MPZP\INNE_GRANICE_INFO,numer,0,10;zrodlo "zrodlo" true true false 255 Text 0 0,First,#,{}\brg_mpzp.gdb\BRG_MPZP\INNE_GRANICE_INFO,zrodlo,0,255;data_zrodl "data_zrodl" true true false 8 Date 0 0,First,#,{}\brg_mpzp.gdb\BRG_MPZP\INNE_GRANICE_INFO,data_zrodl,-1,-1;Id "Id" true true false 20 Text 0 0,First,#,{}\brg_mpzp.gdb\BRG_MPZP\INNE_GRANICE_INFO,Id,0,20;GlobalID "GlobalID" false false true 38 GlobalID 0 0,First,#,{}\brg_mpzp.gdb\BRG_MPZP\INNE_GRANICE_INFO,GlobalID,-1,-1;kod "kod" true true false 4 Text 0 0,First,#,{}\brg_mpzp.gdb\BRG_MPZP\INNE_GRANICE_INFO,kod,0,4', '', ''.format(sciezka))
    else:
        raise  
...
if arcpy.Exists(r"{}\brg_mpzp.gdb\BRG_MPZP\LINIE_INFR_ZAL".format(sciezka)):
    arcpy.management.Append(r"{}\brg_mpzp.gdb\BRG_MPZP\LINIE_INFR_ZAL".format(sciezka), r"{}\BRG_MPZP\LINIE_INFR".format(workspace), "NO_TEST", r'nr_mpzp "nr_mpzp" true true false 10 Text 0 0,First,#,{}\brg_mpzp.gdb\BRG_MPZP\LINIE_INFR_ZAL,nr_mpzp,0,10;byt "byt" true true false 255 Text 0 0,First,#;Id "Id" true true false 20 Text 0 0,First,#,{}\brg_mpzp.gdb\BRG_MPZP\LINIE_INFR_ZAL,Id,0,20;GlobalID "GlobalID" false false true 38 GlobalID 0 0,First,#,{}\brg_mpzp.gdb\BRG_MPZP\LINIE_INFR_ZAL,GlobalID,-1,-1;kod "kod" true true false 4 Text 0 0,First,#,{}\brg_mpzp.gdb\BRG_MPZP\LINIE_INFR_ZAL,kod,0,4', '', ''.format(sciezka))
else:
    pass
...
if arcpy.Exists(r"{}\brg_mpzp.gdb\BRG_MPZP\LINIE_KOM_ZAL".format(sciezka)):
    arcpy.management.Append(r"{}\brg_mpzp.gdb\BRG_MPZP\LINIE_KOM_ZAL".format(sciezka), r"{}\BRG_MPZP\LINIE_KOM".format(workspace), "NO_TEST", r'nr_mpzp "nr_mpzp" true true false 10 Text 0 0,First,#,{}\brg_mpzp.gdb\BRG_MPZP\LINIE_KOM_ZAL,nr_mpzp,0,10;byt "byt" true true false 255 Text 0 0,First,#;szerokosc "szerokosc" true true false 4 Float 0 0,First,#,{}\brg_mpzp.gdb\BRG_MPZP\LINIE_KOM_ZAL,szerokosc,-1,-1;Id "Id" true true false 20 Text 0 0,First,#,{}\brg_mpzp.gdb\BRG_MPZP\LINIE_KOM_ZAL,Id,0,20;GlobalID "GlobalID" false false true 38 GlobalID 0 0,First,#,{}\brg_mpzp.gdb\BRG_MPZP\LINIE_KOM_ZAL,GlobalID,-1,-1;kod "kod" true true false 4 Text 0 0,First,#,{}\brg_mpzp.gdb\BRG_MPZP\LINIE_KOM_ZAL,kod,0,4', '', ''.format(sciezka))
else:
    pass
...
if arcpy.Exists(r"{}\brg_mpzp.gdb\BRG_MPZP\LINIE_KOMPOZ_ZAL".format(sciezka)):
    arcpy.management.Append(r"{}\brg_mpzp.gdb\BRG_MPZP\LINIE_KOMPOZ_ZAL".format(sciezka), r"{}\BRG_MPZP\LINIE_KOMPOZ".format(workspace), "NO_TEST", r'nr_mpzp "nr_mpzp" true true false 10 Text 0 0,First,#,{}\brg_mpzp.gdb\BRG_MPZP\LINIE_KOMPOZ_ZAL,nr_mpzp,0,10;byt "byt" true true false 255 Text 0 0,First,#;Id "Id" true true false 20 Text 0 0,First,#,{}\brg_mpzp.gdb\BRG_MPZP\LINIE_KOMPOZ_ZAL,Id,0,20;GlobalID "GlobalID" false false true 38 GlobalID 0 0,First,#,{}\brg_mpzp.gdb\BRG_MPZP\LINIE_KOMPOZ_ZAL,GlobalID,-1,-1;kod "kod" true true false 4 Text 0 0,First,#,{}\brg_mpzp.gdb\BRG_MPZP\LINIE_KOMPOZ_ZAL,kod,0,4', '', ''.format(sciezka))
else:
    pass
...
if arcpy.Exists(r"{}\brg_mpzp.gdb\BRG_MPZP\PUNKTY_INFR_ZAL".format(sciezka)):
    arcpy.management.Append(r"{}\brg_mpzp.gdb\BRG_MPZP\PUNKTY_INFR_ZAL".format(sciezka), r"{}\BRG_MPZP\PUNKTY_INFR".format(workspace), "NO_TEST", r'byt "byt" true true false 255 Text 0 0,First,#;GlobalID "GlobalID" false false true 38 GlobalID 0 0,First,#,{}\brg_mpzp.gdb\BRG_MPZP\PUNKTY_INFR_ZAL,GlobalID,-1,-1;nr_mpzp "nr_mpzp" true true false 10 Text 0 0,First,#,{}\brg_mpzp.gdb\BRG_MPZP\PUNKTY_INFR_ZAL,nr_mpzp,0,10;kod "kod" true true false 4 Text 0 0,First,#,{}\brg_mpzp.gdb\BRG_MPZP\PUNKTY_INFR_ZAL,kod,0,4;id "id" true true false 20 Text 0 0,First,#,{}\brg_mpzp.gdb\BRG_MPZP\PUNKTY_INFR_ZAL,Id,0,20', '', ''.format(sciezka))
else:
    pass
...
if arcpy.Exists(r"{}\brg_mpzp.gdb\BRG_MPZP\PUNKTY_KOMPOZ_ZAL".format(sciezka)):
    arcpy.management.Append(r"{}\brg_mpzp.gdb\BRG_MPZP\PUNKTY_KOMPOZ_ZAL".format(sciezka), r"{}\BRG_MPZP\PUNKTY_KOMPOZ".format(workspace), "NO_TEST", r'nr_mpzp "nr_mpzp" true true false 10 Text 0 0,First,#,{}\brg_mpzp.gdb\BRG_MPZP\PUNKTY_KOMPOZ_ZAL,nr_mpzp,0,10;byt "byt" true true false 255 Text 0 0,First,#;Id "Id" true true false 20 Text 0 0,First,#,{}\brg_mpzp.gdb\BRG_MPZP\PUNKTY_KOMPOZ_ZAL,Id,0,20;GlobalID "GlobalID" false false true 38 GlobalID 0 0,First,#,{}\brg_mpzp.gdb\BRG_MPZP\PUNKTY_KOMPOZ_ZAL,GlobalID,-1,-1;kod "kod" true true false 4 Text 0 0,First,#,{}\brg_mpzp.gdb\BRG_MPZP\PUNKTY_KOMPOZ_ZAL,kod,0,4', '', ''.format(sciezka))
else:
    pass
...
if arcpy.Exists("BUDOWLE_I_URZADZENIA") and arcpy.Exists("BUDOWLE_I_URZADZENIA_1"):
    budIurzP = mpzpMap.listLayers("BUDOWLE_I_URZADZENIA")[0]
    budIurzL = mpzpMap.listLayers("BUDOWLE_I_URZADZENIA_1")[0]
elif arcpy.Exists("BUDOWLE_I_URZADZENIA"):
    budIurzL = mpzpMap.listLayers("BUDOWLE_I_URZADZENIA")[0]
    budIurzL.name = "BUDOWLE_I_URZADZENIA_1"
elif arcpy.Exists("BUDOWLE_I_URZADZENIA_1"):
    budIurzL = mpzpMap.listLayers("BUDOWLE_I_URZADZENIA_1")[0]
else:
    pass
if arcpy.Exists("BUDYNKI") and arcpy.Exists("BUDYNKI_1"):
    budP = mpzpMap.listLayers("BUDYNKI")[0]
    budL = mpzpMap.listLayers("BUDYNKI_1")[0]
elif arcpy.Exists("BUDYNKI"):
    budL = mpzpMap.listLayers("BUDYNKI")[0]
    budL.name = "BUDYNKI_1"
elif arcpy.Exists("BUDYNKI_1"):
    budL = mpzpMap.listLayers("BUDYNKI_1")[0]
else:
    pass
if arcpy.Exists("EWIDENCJA_GRUNTOW___DZIALKI") and arcpy.Exists("EWIDENCJA_GRUNTOW___DZIALKI_1"):
    ewDzP = mpzpMap.listLayers("EWIDENCJA_GRUNTOW___DZIALKI")[0]
    ewDzL = mpzpMap.listLayers("EWIDENCJA_GRUNTOW___DZIALKI_1")[0]
elif arcpy.Exists("EWIDENCJA_GRUNTOW___DZIALKI"):
    ewDzL = mpzpMap.listLayers("EWIDENCJA_GRUNTOW___DZIALKI")[0]
    ewDzL.name = "EWIDENCJA_GRUNTOW___DZIALKI_1"
elif arcpy.Exists("EWIDENCJA_GRUNTOW___DZIALKI_1"):
    ewDzL = mpzpMap.listLayers("EWIDENCJA_GRUNTOW___DZIALKI_1")[0]
else:
    pass
if arcpy.Exists("EWIDENCJA_GRUNTOW___GRANICZNIKI") and arcpy.Exists("EWIDENCJA_GRUNTOW___GRANICZNIKI_1"):
    ewGrP = mpzpMap.listLayers("EWIDENCJA_GRUNTOW___GRANICZNIKI")[0]
    ewGrL = mpzpMap.listLayers("EWIDENCJA_GRUNTOW___GRANICZNIKI_1")[0]
elif arcpy.Exists("EWIDENCJA_GRUNTOW___GRANICZNIKI"):
    ewGrL = mpzpMap.listLayers("EWIDENCJA_GRUNTOW___GRANICZNIKI")[0]
    ewGrL.name = "EWIDENCJA_GRUNTOW___GRANICZNIKI_1"
elif arcpy.Exists("EWIDENCJA_GRUNTOW___GRANICZNIKI_1"):
    ewGrL = mpzpMap.listLayers("EWIDENCJA_GRUNTOW___GRANICZNIKI_1")[0]
else:
    pass
if arcpy.Exists("EWIDENCJA_GRUNTOW___GRANICA_OBREBU") and arcpy.Exists("EWIDENCJA_GRUNTOW___GRANICA_OBREBU_1"):

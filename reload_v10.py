...
lIi = mpzpMap.listLayers("LINIE_INFR_INFO")[0]

if arcpy.Exists(r"PRZEZ_MIX"):
...
if arcpy.Exists(r"{}\brg_mpzp.gdb\OPISY".format(sciezka)):
    arcpy.FeatureClassToFeatureClass_conversion(r"{}\brg_mpzp.gdb\OPISY".format(sciezka), workspace, "opisy_przeznaczenia")
    ...
    OpisyPrzez.name = "OPISY"
    OpisyPrzez = mpzpMap.listLayers("OPISY")[0]
    for layer in OpisyPrzez.listLayers():
        layer.name = "opisy_przeznaczenia"
    
elif arcpy.Exists(r"{}\brg_mpzp.gdb\opisy_przeznaczenia".format(sciezka)):
    arcpy.FeatureClassToFeatureClass_conversion(r"{}\brg_mpzp.gdb\opisy_przeznaczenia".format(sciezka), workspace, "opisy_przeznaczenia")
    op_przez = r"{}\opisy_przeznaczenia".format(workspace)
    mpzpMap.addDataFromPath(op_przez)
    OpisyPrzez = mpzpMap.listLayers("opisy_przeznaczenia")[0]
    OpisyPrzez.name = "OPISY"
...
arcpy.AddMessage("Niemożliwe, a jednak. Wszystko śmiga!")
